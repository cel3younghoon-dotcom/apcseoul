...
export default function Home() {
  ...
  return (
    <main className="bg-[#FAFAFA] text-[#1A1A1A] font-serif selection:bg-[#B8907A] selection:text-white pb-32">
      ...
      {/* Language Switcher (ENG 버튼) */}
      <div className="fixed top-6 right-6 z-50">
        <a 
          href="/" 
          className="text-xs tracking-[0.2em] font-medium px-4 py-2 border border-[#B8907A] text-[#B8907A] hover:bg-[#B8907A] hover:text-white transition-colors rounded-sm"
        >
          ENG
        </a>
      </div>
